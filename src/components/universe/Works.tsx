    ...
    <section id="uni-works" className="px-6 md:px-[8vw] py-[15vh]">
      ...
      >
        ...
        <h2
          ...
          style={{ fontFamily: '"Instrument Serif", serif', fontSize: "clamp(56px, 10vw, 160px)" }}
        >
          ...
          >
            <div className="relative w-full aspect-square transition-transform duration-700 group-hover:scale-[1.04] group-hover:rotate-[1deg]">
              <Blob
                ...
                src={w.src}
                alt={w.key}
                className="w-full h-full animate-uni-drift-slow"
              />
            </div>
            <div className="mt-8 flex justify-between items-start">
              <div>
                <div className="text-[11px] uppercase tracking-[0.3em] text-[#111]/50 font-mono mb-2">
                  {w.num}
                </div>
                <div
                  className="italic text-4xl md:text-5xl text-[#111] leading-tight"
                  style={{ fontFamily: '"Instrument Serif", serif' }}
                >
                  {getWorkTitle(w.key)}
                </div>
                <p
                  className="text-sm text-[#111]/60 mt-3 max-w-[25ch] leading-relaxed"
                  style={{ fontFamily: '"Instrument Serif", serif' }}
                >
                  {getWorkDesc(w.key)}
                </p>
              </div>
              <div className="text-[10px] uppercase tracking-widest text-[#111]/50 font-mono pt-4">
                {w.year}
              </div>
            </div>
