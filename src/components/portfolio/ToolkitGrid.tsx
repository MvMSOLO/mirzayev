...
const tools = [
  "REACT", "NEXT", "TS", "TAILWIND", "GSAP", "MOTION",
  "NODE", "POSTGRES", "SUPABASE", "PRISMA", "REDIS", "DOCKER",
  "FIGMA", "BLENDER", "AFTER FX", "PREMIERE", "OBS", "CAPCUT",
  "OPENAI", "GEMINI", "CLAUDE", "LLAMA", "PY", "SHELL",
];
  ...
  return (
    <section className="px-5 md:px-20 lg:px-32 py-24 border-t border-border relative overflow-hidden">
      <div className="mb-10 flex gap-2 items-center">
        ...
        <span className="text-[10px] uppercase tracking-widest text-accent">// TOOLKIT · 24 CH</span>
      </div>
      ...
      <div className="grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-px bg-border">
        {tools.map((tool, i) => (
          <div
            key={tool}
