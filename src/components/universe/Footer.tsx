  ...
  return (
    <footer id="uni-contact" className="px-6 md:px-[8vw] py-[15vh] border-t border-[#111]/10">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
        <div>
          <div className="text-[11px] uppercase tracking-[0.4em] text-[#111]/50 mb-8 font-mono">— {t("contact.tag")}</div>
          <h2 className="italic text-[#111] leading-[0.85] mb-12" style={{ fontFamily: '"Instrument Serif", serif', fontSize: "clamp(56px, 10vw, 160px)" }}>
            let's create <br /> something <br /> legendary.
          </h2>
          <p className="max-w-[40ch] text-[#111]/70 text-lg md:text-xl leading-relaxed mb-12" style={{ fontFamily: '"Instrument Serif", serif' }}>
            {t("uni.footer.note")}
          </p>
        ...
        <div className="lg:justify-self-end">
          <div className="text-[11px] uppercase tracking-[0.4em] text-[#111]/50 mb-8 font-mono">— {t("contact.social")}</div>
      ...
      <div className="mt-32 flex flex-col md:flex-row items-center justify-between gap-10 border-t border-[#111]/10 pt-12">
        <div className="text-[10px] uppercase tracking-[0.3em] text-[#111]/40 font-mono text-center md:text-left leading-relaxed">
          © 2026 avazbek mirzayev · all rights reserved <br className="md:hidden" /> · olmaliq 40.9926° N, 69.7431° E
        </div>
        <div className="flex items-center gap-8">
           <button
             onClick={exit}
             className="text-[11px] uppercase tracking-[0.4em] text-[#111]/60 hover:text-[#111] border-b border-[#111]/20 pb-1"
           >
             {t("uni.exit")}
           </button>
        </div>
