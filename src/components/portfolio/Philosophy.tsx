  ...
  return (
    ...
    >
      ...
      <div className="space-y-10 md:space-y-14 max-w-3xl">
        {steps.map((s, i) => (
          <ClipReveal key={s.t} delay={i * 0.1}>
            <div className="grid grid-cols-[auto_1fr] gap-6 md:gap-10 items-start border-t border-border pt-8 group cursor-default">
              <span className="font-display text-5xl md:text-7xl text-accent/20 group-hover:text-accent transition-colors duration-500 leading-none">
                0{i + 1}
              </span>
              <div>
                <h4 className="font-display text-2xl md:text-3xl uppercase tracking-tight mb-3 group-hover:translate-x-2 transition-transform duration-300">
                  {s.t}
                </h4>
