  ...
  return (
    <section id="work" className="px-5 py-24 border-b border-border">
      ...
      <div className="grid grid-cols-6 gap-3">
        <a href="https://github.com/MvMSOLO" target="_blank" rel="noopener noreferrer" className="col-span-6 md:col-span-4 md:row-span-2 group relative border border-border bg-neutral-900/30 aspect-[4/5] md:aspect-auto overflow-hidden">
