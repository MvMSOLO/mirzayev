  ...
  const inner = (
    <span
      className={`relative inline-flex items-center justify-center px-8 py-4 rounded-full border transition-all duration-[600ms] ease-[cubic-bezier(0.16,1,0.3,1)] ${
        primary
          ? "border-[#111] bg-[#111] text-[#F9F6F0] hover:bg-[#DFFF00] hover:text-[#111] hover:border-[#DFFF00]"
          : "border-[#111]/40 text-[#111] hover:border-[#111]"
      }`}
      style={{
    ...
    >
      <span className="italic text-lg" style={{ fontFamily: '"Instrument Serif", serif' }}>
        {children}
      </span>
